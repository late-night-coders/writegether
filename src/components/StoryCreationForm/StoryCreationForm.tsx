...
const StoryCreationForm = ({
  ...
  return <Form {...form} >
    ...
    <form className="flex flex-col space-y-4 lg:space-y-0 lg:flex-row lg:space-x-24" onSubmit={form.handleSubmit(onSubmitHandler)}>
      ...
      <div className="w-full flex flex-col lg:w-1/4 space-y-4">
        <div className="w-full lg:aspect-w-1 lg:aspect-h-1">
          <Button className="w-full h-full min-h-[100px] flex flex-col cursor-pointer border-2 border-dashed border-neon-yellow-600 bg-neon-yellow-100 rounded text-black hover:bg-neon-yellow-200">
